package com.czertainly.np.email;

import com.czertainly.api.exception.*;
import com.czertainly.np.email.dto.ApiErrorResponseDto;
import com.czertainly.np.email.dto.ErrorMessageDto;
...
public class ExceptionHandlingAdvice {
    ...
    public ResponseEntity<Object> handleHttpMessageNotReadableException(HttpMessageNotReadableException ex) {
        ...
        if (cause instanceof InvalidFormatException) {
            ...
            String error = ex.getRootCause() != null ? ex.getRootCause().getMessage() : null;
